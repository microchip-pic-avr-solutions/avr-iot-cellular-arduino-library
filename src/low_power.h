...
/**
 * @brief Multipliers for LTE network power save mode when the LTE modem is
 * periodically sleeping.
 *
...
class LowPowerClass {
  ...
  public:
     ...
     * This will make the LTE modem be active for some time and sleep the
     ...
     * quite a lot of power spent by the LTE modem.
     *
     * This LTE modem keeps track of where it is within this time period, we
     * simply have to tell it that it can save power with the #powerSave()
