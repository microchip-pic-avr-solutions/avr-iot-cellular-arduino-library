...
private:
	...
	* Returns:
	*   Error code: 0 => OK, 1-0xff => cryptoauth error code, >= 0x100: see ecc_provision.h
	*/
	uint8_t readProvisionItem(enum ecc_data_types type, uint8_t *buffer, uint8_t *length);
